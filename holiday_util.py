...
def merge_holiday(original_df: pd.DataFrame, holiday_df: pd.DataFrame) -> pd.DataFrame:
    """
    ...
    Args:
        ...
        holiday_df: Holiday reference dataframe containing date and holiday information
    ...
    result_df = pd.merge(
        original_df,
        holiday_df[["date", "weekday", "description"]],
        left_on='pdate',
        right_on='date',
        how='left'
    )
